...
// NOTE: small changes for period config in constructor
...
contract OVLUniswapV2Feed is IOVLFeed {
  ...
  function update() public {
      ...
      require(timeElapsed >= periodMin, 'ExampleOracleSimple: PERIOD_NOT_ELAPSED');
